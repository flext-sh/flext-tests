"""Type validation scanner for flext-tests."""
...
from .types_part_01 import FlextTestsValidatorTypes as _ValidatorTypesPart01

if TYPE_CHECKING:
    from flext_tests import m


class FlextTestsValidatorTypes(_ValidatorTypesPart01):
