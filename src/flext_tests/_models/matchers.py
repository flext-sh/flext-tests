...
from _pytest.python_api import ApproxBase  # noqa: PLC2701 -- ApproxBase has no public pytest path in the supported versions; justified per fleet suppression law.
