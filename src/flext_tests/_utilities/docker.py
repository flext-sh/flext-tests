...
class FlextTestsDockerUtilities:
    class Tests:
        class Docker:
            ...
            class _OfflineDockerClient:
                ...
                def __init__(self) -> None:
                    ...
                    super().__init__()
                    self._offline_containers: FlextTestsDockerUtilities.Tests.Docker._OfflineContainers = FlextTestsDockerUtilities.Tests.Docker._OfflineContainers()

                @property
                def containers(
                    self,
                ) -> FlextTestsDockerUtilities.Tests.Docker._OfflineContainers:
            ...
            def __init__(
                ...
                self._client: (
                    DockerSDKClient
                    | FlextTestsDockerUtilities.Tests.Docker._OfflineDockerClient
                    | None
                ) = None
            ...
            def cleanup_dirty_containers(self) -> r[list[str]]:
                ...
                for container_name in list(self._dirty_containers):
                    ...
                    self.logger.info(
                        "Recreating dirty container", container=container_name
                    )
...
tk = FlextTestsDockerUtilities.Tests.Docker


__all__ = ["FlextTestsDockerUtilities", "tk"]
