"""Universal value matcher.

Exposes ``Tests.Matchers.that`` for super-powered generalist assertions.
"""
...
class FlextTestsMatchersThatMixin:
    ...
    def _apply_rule(
        ...
        *,
        ...
        FlextTestsMatchersThatMixin.Tests.Matchers.that(
            subject,
            **kwargs,
        )
        ...
        *,
        ...
        for path, rule in rules.items():
            try:
                ...
                FlextTestsMatchersThatMixin._apply_rule(
