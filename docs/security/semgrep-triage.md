...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 602 | |
| 5 | medium | low | `non-literal-import` | `src/flext_tests/_fixtures/settings.py` | 44 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-tests.json`
